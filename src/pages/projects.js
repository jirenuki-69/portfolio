    ...
    <>
      ...
      <main className="w-full mb-16 flex flex-col items-center justify-center dark:text-light">
        <Layout className="pt-16 p-32 xl:p-24 lg:p-16 md:p-12 sm:pt-8">
          <AnimatedText
            text="Every Project is a Piece of Coding"
          ...
          <div className="grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0">
            <div className="col-span-12">
              <FeaturedProject
                ...
                link="https://superlative-crostata-07aad6.netlify.app/"
                summary="Pokedex developed with React, Redux and styled-components where you can search you favorite pokemons! NOTE: You can login with any valid email and password, it is only a frontend project."
                github="https://github.com/jirenuki-69/Pokedex"
                img={pokedexImage}
              />
            </div>
            <div className="col-span-6 sm:col-span-12">
              <Project
                ...
                type="Landing Page"
                link="https://iridescent-sopapillas-9098d1.netlify.app/"
                github="https://github.com/jirenuki-69/modern-landing-page"
                img={modernLandingImage}
              />
            </div>
            <div className="col-span-6 sm:col-span-12">
