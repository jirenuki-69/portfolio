...
const About = () => {
  return (
    <>
      <Head>
        <title>MiguelFuentes | About me</title>
        <meta
          name="description"
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            <div className="col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:col-span-8 md:order-2">
              ...
              <p className="text-justify font-medium">
                Hi! I'm Miguel, a web and mobile frontend developer with a
              ...
              <p className="my-4 text-justify font-medium">
                I believe that software engineering is about more than just
                coding – it's about solving problems and creating intuitive,
                enjoyable experiences for all the people.{' '}
              </p>
              <p className="text-justify font-medium">
